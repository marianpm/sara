// src/features/aprobaciones/AprobacionesPanel.jsx
import React, { useCallback, useEffect, useState } from "react";
import { Card, CardContent } from "../../shared/ui/card";
import { Button } from "../../shared/ui/button";
import { supabase } from "../../shared/lib/supabaseClient";
import { registrarLog } from "../../shared/services/logsEventos";
import { formatFecha } from "../pedidos/utils/pedidosUtils";
                        ...
                        ped.productos.length > 0 && (
                          <ul className="mt-1 list-disc list-inside text-xs text-slate-600">
                            {ped.productos.map((prod, idx) => (
                              <li key={idx}>
                                {prod.productoNombre} — {prod.presentacion} x {prod.cantidad} — ({prod.precioPorKg} $/kg)
                                {prod.peso != null &&
