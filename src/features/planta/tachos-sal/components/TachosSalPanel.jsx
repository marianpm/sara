...
import TachosSalConfigPanel from "./TachosSalConfigPanel";
...
export default function TachosSalPanel({ usuarioActual }) {
  ...
  const [vistaPrincipal, setVistaPrincipal] = useState("movimientos");
    ...
    <section className="planta-card">
      <div className="planta-card-header">
        ...
        <div className="flex gap-2 rounded-full bg-slate-100 p-1">
          <Button
            type="button"
            variant={vistaPrincipal === "movimientos" ? "default" : "ghost"}
            className="rounded-full text-xs sm:text-sm"
            onClick={() => {
              setVistaPrincipal("movimientos");
              setMensaje(null);
              cargarDatos();
            }}
          >
          ...
          {esAdmin && (
            <Button
              type="button"
              variant={vistaPrincipal === "configuracion" ? "default" : "ghost"}
              className="rounded-full text-xs sm:text-sm"
              onClick={() => {
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                ...
                <div className="space-y-1">
                  ...
                  <Input
                    ...
                    max={hoy}
                    value={fechaIngreso}
                    disabled={!esAdmin || guardandoIngreso}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-5 shadow-xl">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Vas a marcar como egresados los tachos{" "}
              <strong>
                {formatearListaNumeros(
                  movimientosAEgresar.map((mov) => Number(mov.tacho_numero))
                )}
              </strong>
              .
            </p>
