// src/components/clientes/ClientesPanel.jsx
    ...
    const pedidosDelCliente = (pedidosHistorial || [])
      ...
      .sort((a, b) => {
        const fechaA = new Date(
          a.fecha_solicitada || a.fecha || a.fechaCreacion || a.created_at || 0
        ).getTime();

        const fechaB = new Date(
          b.fecha_solicitada || b.fecha || b.fechaCreacion || b.created_at || 0
        ).getTime();
                      ...
                      <td className="px-4 py-3 text-center">
                        <div className="flex justify-center gap-2">
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => abrirHistorialCliente(cliente)}
                          >
                            Historial
                          </Button>
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => abrirMensajeCliente(cliente)}
            ...
            <div className="border-b px-5 py-4">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    {nombreVisibleCliente(clienteHistorial)} · ID cliente{" "}
                    {clienteHistorial.id}
                  </p>
                </div>
                ...
                <Button
                  ...
                  disabled={cargandoPedidosHistorial}
                >
                  Cerrar
                </Button>
              </div>
                  ...
                  <table className="w-full min-w-[860px] text-sm">
                    <thead className="border-b bg-slate-50 text-left text-xs uppercase tracking-wide text-slate-500">
                      <tr>
                        ...
                        <th className="w-[120px] px-4 py-3 text-center">Detalle</th>
                      </tr>
                    </thead>
                          ...
                          <tr key={pedido.id} className="border-b last:border-b-0">
                            ...
                            <td className="w-[120px] px-4 py-3 text-center">
                              <Button
                                ...
                                onClick={() => setPedidoDetalleHistorial(pedido)}
                              >
                                Ver detalle
                              </Button>
                            </td>
              ...
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  <p className="text-sm text-slate-500">
                    ...
                    {formatFecha(
                      pedidoDetalleHistorial.fecha_solicitada ||
                        pedidoDetalleHistorial.fecha ||
                        pedidoDetalleHistorial.created_at
                    )}
                  </p>
                </div>
            ...
            <div className="space-y-4 p-5">
              <div className="grid gap-2 text-sm text-slate-700 md:grid-cols-2">
                ...
                <div>
                  ...
                  {pedidoDetalleHistorial.tipo_entrega ||
